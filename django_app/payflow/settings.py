...
# Load .env from repository root (one level above django_app) if present
...
# Database configuration: prefer Postgres if DB_NAME is set, otherwise fall back to sqlite3
